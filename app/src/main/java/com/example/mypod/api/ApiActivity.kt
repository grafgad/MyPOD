...
class ApiActivity : AppCompatActivity() {
    ...
    private fun setEarthTabHighlighted(layoutInflater: LayoutInflater) {
        val earth =
            layoutInflater.inflate(R.layout.custom_tab_earth, null)
        ...
        tab_layout.getTabAt(MARS)?.customView =
            layoutInflater.inflate(R.layout.custom_tab_mars, null)
        tab_layout.getTabAt(WEATHER)?.customView =
            layoutInflater.inflate(R.layout.custom_tab_weather, null)
    }
